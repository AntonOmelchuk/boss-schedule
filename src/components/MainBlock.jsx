  ...
  return (
    <div className="relative mb-10 rounded-xl p-0.5 overflow-hidden shadow-2xl">
      <div
        ...
        bg-[conic-gradient(from_90deg_at_50%_50%,#0f172a_0%,#f59e0b_50%,#dc2626_75%,#0f172a_100%)]
        animate-[spin_4s_linear_infinite]"
      ></div>

      <div
        className="bg-slate-800/95 backdrop-blur-xl rounded-xl p-6 relative z-10 flex flex-col
      ...
      >
        ...
        <div
          className={`text-5xl md:text-6xl font-mono tracking-widest drop-shadow-lg font-bold
            ${nearestEvent ? "text-white" : "text-green-500 animate-pulse"}`}
        >
          {nearestEvent
