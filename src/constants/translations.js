...
export default {
  [LANGUAGES.UA]: {
    ...
    navTournament: "Турніри",
    tournament: {
      badge: "TOURNAMENT",
      pageTitle: "Альянсові Турніри",
      pageDescription:
        "Організація турнірів між КП на виліт або за круговою системою",
      setupTitle: "Створення нового турніру",
      tournamentTitleLabel: "Назва турніру",
      tournamentTitlePlaceholder: "напр. Літній Кубок Альянсу",
      typeLabel: "Формат турніру",
      typeRoundRobin: "Кругова система (Ліга)",
      typeSingleElimination: "Турнір на виліт (Сітка)",
      selectCpsLabel: "Оберіть КП-учасники",
      startBtn: "Розпочати турнір",
      minCpAlert: "Для початку турніру потрібно щонайменше 2 КП!",
      resetBtn: "Скинути турнір",
      resetConfirm: "Ви впевнені, що хочете видалити поточний турнір?",
      noActiveTournamentTitle: "Активних турнірів немає",
      noActiveTournamentSubtitle:
        "Зачекайте, поки керівництво розпочне новий турнір.",
      standingsTitle: "Турнірна Таблиця",
      teamHeader: "Команда / КП",
      pHeader: "І",
      wHeader: "В",
      dHeader: "Н",
      lHeader: "П",
      diffHeader: "+/-",
      ptsHeader: "Очки",
      filterAllMatches: "Усі матчі",
      filterUpcoming: "Майбутні",
      filterCompleted: "Завершені",
      filterAllCps: "Усі КП",
      exportScreenshotBtn: "скріншот",
      savingScreenshot: "Збереження...",
      roundLabel: "Раунд",
      statusFinished: "Завершено",
      statusPending: "Очікується",
      defaultTitle: "PvP Турнір Альянсу",
      bracketTitle: "Турнірна Сітка",
      byeNotice: "Авто-прохід у наступний раунд",
      finalRound: "Фінал 🏆",
  ...
  [LANGUAGES.EN]: {
    ...
    navTournament: "Tournaments",
    tournament: {
      badge: "TOURNAMENT",
      pageTitle: "Alliance Tournaments",
      pageDescription:
        "Organize CP tournaments with single elimination or round-robin league system",
      setupTitle: "Create New Tournament",
      tournamentTitleLabel: "Tournament Title",
      tournamentTitlePlaceholder: "e.g. Summer Alliance Cup",
      typeLabel: "Tournament Format",
      typeRoundRobin: "Round Robin (League)",
      typeSingleElimination: "Single Elimination (Bracket)",
      selectCpsLabel: "Select Participating CPs",
      startBtn: "Start Tournament",
      minCpAlert: "At least 2 CPs are required to start a tournament!",
      resetBtn: "Reset Tournament",
      resetConfirm: "Are you sure you want to reset the current tournament?",
      noActiveTournamentTitle: "No Active Tournaments",
      noActiveTournamentSubtitle:
        "Wait for leadership to launch a new tournament.",
      ...
      filterAllCps: "All CPs",
      exportScreenshotBtn: "Screenshot",
      savingScreenshot: "Saving...",
      roundLabel: "Round",
      statusFinished: "Finished",
      statusPending: "Pending",
      defaultTitle: "Alliance PvP Tournament",
      bracketTitle: "Tournament Bracket",
      byeNotice: "Bye advancement",
      finalRound: "Finals 🏆",
