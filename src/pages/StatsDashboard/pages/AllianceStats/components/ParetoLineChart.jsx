          ...
          <div className="relative group cursor-pointer">
            ...
            >
              ...
              <p className="leading-relaxed">
                This curve illustrates the cumulative power growth of the
                alliance from left to right. The Pareto Principle (80/20) shows
                how the workload or points are distributed. If the line rises
                steeply at the beginning, a few top CPs drive most of the
                alliance's results. If the curve is smooth and gradual,
                contributions are distributed more evenly across all members.
              </p>
            </div>
          </div>
        </div>
